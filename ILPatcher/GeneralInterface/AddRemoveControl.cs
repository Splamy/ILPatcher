...
namespace ILPatcher.GeneralInterface
{
	public partial class AddRemoveControl : Control
	{
		...
		private void InitializeComponent()
		{
			...
			foreach (Button btn in components.Components)
			{
				btn.BackColor = Color.FromArgb(((int)(((byte)(128)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))));
				btn.FlatAppearance.BorderColor = Color.Blue;
				btn.FlatAppearance.MouseOverBackColor = Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(255)))), ((int)(((byte)(255)))));
